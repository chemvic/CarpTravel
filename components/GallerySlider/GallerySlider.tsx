...
const GallerySlider: React.FC = () => {
  return (
    <div className="hidden relative md:block  mx-auto md:px-[32px] xl:px-[0] md:w-[768px] xl:w-[1280px] ">
      ...
      <button
        type="button"
        className="button-prev block py-[7px] text-[33px]  font-thin uppercase  absolute z-10  md:left-[70px] xl:left-[200px] xl:leading-none md:bottom-[17px] xl:bottom-0  transition-colors duration-300 ease-in-out hover:bg-white/20  focus:bg-white/20"
      >
        back
      </button>
      <button
        type="button"
        className="button-next block py-[7px] text-[33px]  font-thin uppercase  absolute z-10  md:right-[70px] xl:right-[260px] xl:leading-none md:bottom-[17px] xl:bottom-0  transition-colors duration-300 ease-in-out hover:bg-white/20  focus:bg-white/20"
      >
        next
      </button>
    </div>
