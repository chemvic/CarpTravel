      ...
      <div className="container">
        <div className="grid-1">
          <div className="about-title mb-[14px]">
            <h2
              className="text-[40px] font-thin uppercase leading-none tracking-[-1.6px] md:text-[67px]
          ...
          <div className="about-text max-w-[180px]  md:max-w-[221px] xl:max-w-[292px] ">
            <p className="text-[14px] font-extralight tracking-normal leading-[1.25]  mb-[14px] md:text-[16px] md:mb-[16px] xl:text-[18px] xl:leading-[1.333] xl:mb-[24px]">
            ...
            <p className="text-[14px] font-extralight tracking-normal leading-[1.25] md:text-[16px] xl:text-[18px] xl:leading-[1.333] xl:mb-[72px]">
          ...
          <div className="about-slogan flex items-end">
            <div className="ml-auto max-w-[180px] my-[40px] md:mx-0 md:my-0 md:max-w-[221px] xl:max-w-[296px]">
              <p className="text-left text-[14px] uppercase font-normal tracking-normal leading-[1.25]  md:text-[16px] xl:text-[18px] xl:leading-[1.333]">
                From vacationers
              </p>
              <p className="text-right text-[14px] uppercase font-normal tracking-normal leading-[1.25]  md:text-[16px] xl:text-[18px] xl:leading-[1.333]">
                to active travelers
              </p>
              <p className="text-justify text-[14px] font-extralight tracking-[-0.14px] leading-[1.25]  md:text-[16px] md:tracking-[0.32px] xl:text-[18px] xl:tracking-[2.1px] xl:leading-[1.333]">
                we have a tour for everyone.
              </p>
            </div>
          </div>
          <div className="about-methods  max-w-[480px] md:max-w-[463px] md:mt-[64px] xl:max-w-[605px]">
            <p className="text-justify text-[14px] font-extralight tracking-normal leading-[1.25] md:text-[16px] xl:text-[18px] xl:leading-[1.333]">
