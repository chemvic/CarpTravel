  ...
  return (
    <section id="gallery" className="section gallery">
      <div className="container flex flex-col items-center gap-[24px] md:gap-[72px] xl:gap-[24px]">
        <h2 className="uppercase text-[40px] font-thin leading-[1.4] tracking-[-1.6px]  md:text-[67px] md:leading-[0.985] md:tracking-[-2.68px] xl:text-[98px] xl:leading-[1.21] xl:tracking-[-3.92px] xl:self-start ">
