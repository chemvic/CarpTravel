      ...
      <div className="section career">
        <div className="container flex flex-col gap-[36px] md:gap-[12px] xl:gap-[24px] ">
          <div className="flex flex-col gap-[24px] md:flex-row justify-between">
            ...
            <p className="w-[179px] self-end text-[14px] font-extralight leading-[1.428]  md:text-[16px] md:leading-[1.25] md: text-justify md:w-[221px] xl:text-[18px] xl:leading-[1.333] xl:w-[293px] ">
          ...
          <div className="flex flex-col md:flex-row md:justify-between ">
            <div className="flex flex-col gap-[36px] md:gap-[56px] xl:gap-[45px] ">
              <h3 className="text-[30px] font-extralight uppercase text-left w-[179px] self-end md:w-[221px] md:self-start md:text-right xl:w-[297px] xl:text-[36px] xl:leading-[1.083]">
                Why us ?
              </h3>
              <ul className="flex flex-col w-[181px] gap-[16px] md:w-[221px] md:gap-[24px] xl:w-[616px] ">
                <li className="flex flex-col gap-[8px] text-right xl:flex-row xl:justify-between ">
                  <p className="text-[14px] font-regular tracking-normal leading-[1.429] md:text-[16px] md:leading-[1.25] xl:w-[297px] xl:text-[18px] xl:leading-[1.333] ">
                    Professional development
                  </p>
                  <p className="text-[12px] font-extralight leading-[1.667]  xl:leading-[2] xl:w-[285px] xl:text-left ">
            ...
            <div className="hidden md:flex md:flex-col md:pt-[102px] md:gap-[32px] md:w-[463px] xl:pt-0 xl:gap-[14px] xl:w-[600px] ">
              <p className="text-[14px] font-extralight leading-[1.428]  md:text-[16px] md:leading-[1.25] xl:text-[18px] xl:leading-[1.333] w-[179px] self-end md:self-start md:w-[210px] xl:w-[234px]">
