        ...
        <div className="container flex flex-col gap-[36px] md:gap-[12px] xl:gap-[24px] ">
            ...
            <div className="flex flex-col md:flex-row md:justify-between ">
                <div className="flex flex-col gap-[36px] md:gap-[56px] xl:gap-[45px] ">
                    <h3 className="text-[30px] font-extralight uppercase text-left w-[179px] self-end md:w-[221px] md:self-start md:text-right xl:w-[297px] xl:text-[36px] xl:leading-[1.083]">Why us ?</h3>
                    <ul className="flex flex-col w-[181px] gap-[16px] md:w-[221px] md:gap-[24px] xl:w-[616px] ">
                        <li className="flex flex-col gap-[8px] text-right xl:flex-row xl:justify-between ">
                            <p className="text-[14px] font-regular tracking-normal leading-[1.429] md:text-[16px] md:leading-[1.25] xl:w-[297px] xl:text-[18px] xl:leading-[1.333] ">Professional development</p>
                        ...
                        <li className="flex flex-col gap-[8px] text-right xl:flex-row xl:justify-between ">
                            <p  className="text-[14px] font-regular tracking-normal leading-[1.429] md:text-[16px] md:leading-[1.25] xl:w-[297px] xl:text-[18px] xl:leading-[1.333] ">Teamwork</p>
