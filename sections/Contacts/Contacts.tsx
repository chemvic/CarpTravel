  ...
  return (
    <section id="contacts" className="section contacts">
      <div className="container flex flex-col">
        <h2 className="uppercase mb-[36px] text-[40px] font-thin leading-[1.4] tracking-[-1.6px] md:text-justify md:text-[67px] md:leading-[0.985] md:tracking-[-2.68px] xl:text-[98px] xl:leading-[1.21] xl:tracking-[-3.92px] xl:mb-[71px] ">
          ...
          <address className="flex flex-col md:flex-row md:gap-[90px] md:ml-auto xl:flex-col xl:gap-[124px]">
            <ul className="not-italic">
              <li className="flex flex-row-reverse gap-[20px] mb-[24px]">
                <p className="text-[12px] font-extralight leading-[1.714] tracking-none xl:leading-[2]">
                  Phone number
                </p>
                <ul>
                  <li>
              ...
              <li className="flex flex-row-reverse gap-[20px]  mb-[24px]">
                <p className="text-[12px] font-extralight leading-[1.714] min-w-[81px] align-bottom tracking-none xl:leading-[2]  text-left xl:min-w-[81px] ">
                  E-mail
                </p>
                <a
            ...
            <div className="not-italic mb-[12px] flex gap-[20px] self-end xl:flex-row-reverse">
              <p className="text-[12px] font-extralight leading-[1.714] tracking-none xl:leading-[2] xl:min-w-[81px]">
                Follow us
              </p>
